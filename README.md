...
| ------------- |:-------------:| :-------: | :-------: |
| users        | 7.3 | 8 + 30 + 50 + 32 + 50 + 50 + 1 = 221 Б | 1.5 Тб |
| recipients |  7.3 | 8 + 50 * 6 + 4 * 2 + 20 + 100 + 8 = 444 Б | 3.02 Тб |
| payments_details    | 7.3 | 8 + 16 + 8 + 32 + 8 = 72 Б | 1.16 Тб |
| shopping_cards  | 7.3 | 8 + 4 + 8 + 8 = 36 Б| 0.24 Тб |
| stores  | 0.73 | 8 + 50 + 200 + 8 = 266 Б| 0.18 Тб |
| products  | 266 | 8 + 50 + 200 + 4 + 8 * 9 + 8 + 8 + 8 = 358 Б| 88 Тб |
| media  | 2394 | 8 + 100 + 50 = 158 Б| 352 Тб |
| comments  | 0.365 | 8 + 200 + 4 + 8 * 3 = 236 Б| 0.08 Тб |
| categories (без parent_id)  | 0.000023 | 8 + 50 = 58 Б| 1.3 Мб |
| categories (с parent_id)  | 0.000253 | 8 + 50 + 8 = 66 Б| 16 Мб |
| orders  | 3863 | 8 + 4 + 8 + 10 + 8 * 4 = 62 Б| 223 Тб |
| payments  | 3863 | 10 + 8 * 4 = 42 Б| 151 Тб |

**Итого:** ~2920 Тб или 2.9 Пб в год (без учета медиа - они были выше)
